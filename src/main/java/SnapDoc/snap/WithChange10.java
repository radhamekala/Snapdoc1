...
public class WithChange10 extends TestBase {

	String initiatedBy = "Ankita Ghosh";
	String InitiatedBy = "Ankita Ghosh ";
	String Category = "Analytical";
	String Subcategory = "Specification";
	String Type = "HydroCloride"; // Chroro 1MG- change control //Topiramite //amisulpride//Topiramite 1-not//
	String Typenames = " HydroCloride ";
	String TypeCode = "AC1";
	String OrgID = "Org301";
	String Number = "301";
	String Description = "Hydrosulf 25c 2MG"; // mandatory change
	String ReviewPeriod = "2";
	String Makeeffectivelevelname = "frist";
	String TypeName2 = " Sample 1 ";
	String changecontrolnumbar = "7194";
	String changecontrolDescription = "change control descriptions 3";
	String Title = "Hydrosulfaror 24";
	String TypeDescription = "Amisulpride 33MG material";
//	String OrgID = "Org0023";
//	String Number = "0043 ";
	String displayNumber = " 301(Org301) ";
	String SubDOcNumber = "301(Org301)";
	String vertion = "0";
	String expectedTitlenuber = "Hydrosulfaror 24 \n301 (Org301) Ver 0.00";// title orgid number version
...
//		System.out.println("Material name not displayed");
		...
		try {
			...
			System.out.println("not able select " + Action);
			System.out.println("Exception : " + e);
		}
		CM.clickonElementbyXpath(EL.eleUsersetting_XP, "USER SETTINGS");
		CM.clickonElementbyXpath(EL.eleLogout_XP, "Log out");
...
//					System.out.println("Material name not displayed");
	...
	// Reviewer
			...
			try {
				...
				System.out.println("not able select " + "Resubmit");
				System.out.println("Exception : " + e);
			}
			CM.clickonElementbyXpath(EL.eleUsersetting_XP, "USER SETTINGS");
			CM.clickonElementbyXpath(EL.eleLogout_XP, "Log out");
