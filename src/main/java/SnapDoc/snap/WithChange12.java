...
public class WithChange12 extends TestBase {
	String initiatedBy = "Ankita Ghosh";
//	String InitiatedBy = "Ankita Ghosh ";
	String Category = "Analytical";
	String Subcategory = "Specification";
	String Type = "HydroClorophine"; // Chroro 1MG- change control //Topiramite //amisulpride//Topiramite 1-not//
//	String Typenames = " HydroClorophine ";
	String TypeCode = "AB1";
	String OrgID = "Org275";
	String Number = "275";
	String Description = "Hydrosulf 14c 2MG"; // mandatory change
	String ReviewPeriod = "2";
	String Makeeffectivelevelname = "frist";
	String TypeName2 = " Sample 1 ";
	String changecontrolnumbar = "7594";
	String changecontrolDescription = "change control descriptions 2";
	String Title = "Hydrosulfaror 34";
	String TypeDescription = "Amisulpride 33MG material";
//	String OrgID = "Org0023";
//	String Number = "0043 ";
	String displayNumber = "275(Org275)";
//	String SubDOcNumber = "275(Org275)";
	String vertion = "0";
	String expectedTitlenuber = "Hydrosulfaror 34 \n275 (Org275) Ver 0.00";// title orgid number version
...
//		String StringExpectstep2 = "Default Tasks for Reviewers";
		try {
			WebElement TaskReviewer = driver.findElement(By.xpath(
					"(//thead[@class='t-grid-header'])[5]/following-sibling::tbody/tr[1]/td[text()='Default Tasks for Reviewers']"));
...
//Approver
		...
		try {
			WebElement TaskApprover = driver.findElement(By.xpath(
					"(//thead[@class='t-grid-header'])[5]/following-sibling::tbody/tr[2]/td[text()='Approval 1']"));
...
//		}
	...
	public void Reviewer1Resubmit() throws InterruptedException {
		Thread.sleep(5000);
		try {
