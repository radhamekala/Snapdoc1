...
public class Type5 extends TestBase {
	String Type = "Topiramite 3";    //pantoprazole //sodium//atorvastatin //aripiprazole //amisulpride //
	String TypeCode = "c1123";
	String TypeDescription = "All permission";
	String ReviewPeriod = "2";
	String Makeeffectivelevelname = "frist";

	public void type5() throws InterruptedException { // change needed only for all workflows designased based
																// only
