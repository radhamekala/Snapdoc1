...
public class WithChange7 extends TestBase {
	
		String initiatedBy = "Ankita Ghosh";
		String InitiatedBy = "Ankita Ghosh ";
		String Category = "Analytical";
		String Subcategory = "Specification";
		String Type = "Hydroxys001"; // Chroro 1MG- change control //Topiramite //amisulpride//Topiramite 1-not//
		String Typenames = " Hydroxys001 ";
		String TypeCode = "AD1";
		String OrgID = "Org266";
		String Number = "266";
...
//			System.out.println("Material name not displayed");
		...
		public void Reviewer1Reject() throws InterruptedException {
			Thread.sleep(5000);
			try {
				WebElement titlenemes = driver.findElement(By.xpath("//b[text()='My Approvals']"));
				if (titlenemes.isDisplayed()) {
