...
public class WithChange2 extends TestBase{
	...
	String changecontrolnumbar = "7593";
	String changecontrolDescription = "change control descriptions 2";
	String Title = "Hydrosulfaror 17";
	String TypeDescription = "Amisulpride 33MG material";
//	String OrgID = "Org0023";
//	String Number = "0043 ";
	String displayNumber = " 265(Org265) ";
	String SubDOcNumber = "265(Org265)";
	String vertion = "0";
	String expectedTitlenuber = "Hydrosulfaror 17 \n265 (Org265) Ver 0.00";// title orgid number version
